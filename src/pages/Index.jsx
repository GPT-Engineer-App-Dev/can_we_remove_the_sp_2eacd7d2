  ...
  return (
    <Flex direction="column" h="100vh" justify="center" p={4}>
      ...
      <Flex direction={{ base: "column", md: "row" }} align="center" justify="center" mb={4}>
        ...
        <Button leftIcon={<FaTimes />} rightIcon={<FaArrowRight />} colorScheme="blue" size={buttonSize} alignSelf={{ base: "center", md: "end" }} mx={{ base: 0, md: 2 }} my={{ base: 4, md: 0 }} display={{ base: "none", md: "flex" }}>
          Skip
        </Button>
        <VStack>
